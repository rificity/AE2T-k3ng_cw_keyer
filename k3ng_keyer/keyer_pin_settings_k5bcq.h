...
#define sidetone_line 31         // connect a speaker for sidetone   Set to "31" for Twin T oscillator
#endif                          // you still need to move P4A and P4B jumpers
#ifndef OPTION_SIDETONE_DIGITAL_OUTPUT_NO_SQUARE_WAVE
#define sidetone_line 12          // connect a speaker for sidetone   Set to "12" if not using Twin T oscillator
#endif
