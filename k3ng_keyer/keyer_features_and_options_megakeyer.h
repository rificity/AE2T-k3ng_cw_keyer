...
#define FEATURE_TWO_RIG //if enabled, PTT output becomes key out for rig 2
...
//#define FEATURE_CMOS_SUPER_KEYER_IAMBIC_B_TIMING //this seems to prevent the paddles from stopping a sending memory
